...
public class PhoneDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "PhoneData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PhoneDataTypeSupport _singleton
    = new PhoneDataTypeSupport();
    ...
    */
    public static PhoneDataTypeSupport get_instance() {
        return _singleton;
    }

    public static PhoneDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PhoneDataTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return PhoneData.create();
    }
    ...
    * <code>this</code> is not a <code>PhoneData</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        PhoneData typedDst = (PhoneData) destination;
        PhoneData typedSrc = (PhoneData) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        PhoneData typedSrc = (PhoneData) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.deviceID);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PhoneData typedDst = (PhoneData) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PhoneData typedDst = (PhoneData) sample;
            deserialize_sample(
    ...
    int mask) {
        return new PhoneDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PhoneDataDataReader(native_reader, listener, mask, this);   
    ...
    protected PhoneDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, PhoneDataTypeCode.VALUE, PhoneData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PhoneDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, PhoneDataTypeCode.VALUE, PhoneData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
