...
/**
* A sequence of PhoneData instances.
*/
public final class PhoneDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PhoneDataSeq (int initialMaximum) {
        super(PhoneData.class, initialMaximum);
    }

    public PhoneDataSeq (Collection<?> elements) {
        super(PhoneData.class, elements);
    }

    public  PhoneData get(int index) { 
        return (PhoneData) super.get(index); 
    }
