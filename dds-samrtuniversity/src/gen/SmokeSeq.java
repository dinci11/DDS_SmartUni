...
/**
* A sequence of Smoke instances.
*/
public final class SmokeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SmokeSeq (int initialMaximum) {
        super(Smoke.class, initialMaximum);
    }

    public SmokeSeq (Collection<?> elements) {
        super(Smoke.class, elements);
    }

    public  Smoke get(int index) { 
        return (Smoke) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Smoke objects (beyond the original size of this object)
