...
public class SmokeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Smoke";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SmokeTypeSupport _singleton
    = new SmokeTypeSupport();
    ...
    */
    public static SmokeTypeSupport get_instance() {
        return _singleton;
    }

    public static SmokeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SmokeTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Smoke</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Smoke typedDst = (Smoke) destination;
        Smoke typedSrc = (Smoke) source;
    ...
    int mask) {
        return new SmokeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SmokeDataReader(native_reader, listener, mask, this);   
    ...
    protected SmokeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, SmokeTypeCode.VALUE, Smoke.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SmokeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, SmokeTypeCode.VALUE, Smoke.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
