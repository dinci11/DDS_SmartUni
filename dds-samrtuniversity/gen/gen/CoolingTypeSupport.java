...
public class CoolingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Cooling";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CoolingTypeSupport _singleton
    = new CoolingTypeSupport();
    ...
    */
    public static CoolingTypeSupport get_instance() {
        return _singleton;
    }

    public static CoolingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CoolingTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return Cooling.create();
    }
    ...
    * <code>this</code> is not a <code>Cooling</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Cooling typedDst = (Cooling) destination;
        Cooling typedSrc = (Cooling) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        Cooling typedSrc = (Cooling) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Cooling typedDst = (Cooling) sample;
            deserialize_sample(
    ...
    int mask) {
        return new CoolingDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CoolingDataReader(native_reader, listener, mask, this);   
    ...
    protected CoolingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, CoolingTypeCode.VALUE, Cooling.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CoolingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, CoolingTypeCode.VALUE, Cooling.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
