...
public class WindowOpenTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "WindowOpen";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WindowOpenTypeSupport _singleton
    = new WindowOpenTypeSupport();
    ...
    */
    public static WindowOpenTypeSupport get_instance() {
        return _singleton;
    }

    public static WindowOpenTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WindowOpenTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return WindowOpen.create();
    }
    ...
    * <code>this</code> is not a <code>WindowOpen</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        WindowOpen typedDst = (WindowOpen) destination;
        WindowOpen typedSrc = (WindowOpen) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        WindowOpen typedSrc = (WindowOpen) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.intensity);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WindowOpen typedDst = (WindowOpen) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.intensity = src.readDouble();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WindowOpen typedDst = (WindowOpen) sample;
            deserialize_sample(
    ...
    int mask) {
        return new WindowOpenDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WindowOpenDataReader(native_reader, listener, mask, this);   
    ...
    protected WindowOpenTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, WindowOpenTypeCode.VALUE, WindowOpen.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WindowOpenTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, WindowOpenTypeCode.VALUE, WindowOpen.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
