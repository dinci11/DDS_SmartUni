...
public class WeatherDataTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "WeatherData";
    ...
    */
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.outTemperature);
            dst.writeInt(typedSrc.outHumidity);
            dst.writeInt(typedSrc.windSpeed);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                typedDst.outTemperature = src.readInt();
                typedDst.outHumidity = src.readInt();
                typedDst.windSpeed = src.readInt();
    ...
    int mask) {
        return new WeatherDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WeatherDataDataReader(native_reader, listener, mask, this);   
