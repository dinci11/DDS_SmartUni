...
public class CalendarDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "CalendarData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CalendarDataTypeSupport _singleton
    = new CalendarDataTypeSupport();
    ...
    */
    public static CalendarDataTypeSupport get_instance() {
        return _singleton;
    }

    public static CalendarDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CalendarDataTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CalendarData</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        CalendarData typedDst = (CalendarData) destination;
        CalendarData typedSrc = (CalendarData) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        CalendarData typedSrc = (CalendarData) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.date);
            dst.writeBoolean(typedSrc.isWeekday);
            dst.writeBoolean(typedSrc.isNationalHoliday);
            dst.writeBoolean(typedSrc.isUniversityHoliday);
            dst.writeBoolean(typedSrc.isLecture);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CalendarData typedDst = (CalendarData) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.date = src.readLong();
                typedDst.isWeekday = src.readBoolean();
                typedDst.isNationalHoliday = src.readBoolean();
                typedDst.isUniversityHoliday = src.readBoolean();
                typedDst.isLecture = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CalendarData typedDst = (CalendarData) sample;
            deserialize_sample(
    ...
    int mask) {
        return new CalendarDataDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CalendarDataDataReader(native_reader, listener, mask, this);   
    ...
    protected CalendarDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, CalendarDataTypeCode.VALUE, CalendarData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CalendarDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, CalendarDataTypeCode.VALUE, CalendarData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
