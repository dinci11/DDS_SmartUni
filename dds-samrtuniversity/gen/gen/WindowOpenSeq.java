...
/**
* A sequence of WindowOpen instances.
*/
public final class WindowOpenSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WindowOpenSeq() {
        super(WindowOpen.class);
    }

    public WindowOpenSeq (int initialMaximum) {
        super(WindowOpen.class, initialMaximum);
    }

    public WindowOpenSeq (Collection<?> elements) {
        super(WindowOpen.class, elements);
    }

    public  WindowOpen get(int index) { 
        return (WindowOpen) super.get(index); 
    }
