...
/**
* A sequence of CalendarData instances.
*/
public final class CalendarDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CalendarDataSeq() {
        super(CalendarData.class);
    }

    public CalendarDataSeq (int initialMaximum) {
        super(CalendarData.class, initialMaximum);
    }

    public CalendarDataSeq (Collection<?> elements) {
        super(CalendarData.class, elements);
    }

    public  CalendarData get(int index) { 
        return (CalendarData) super.get(index); 
    }
