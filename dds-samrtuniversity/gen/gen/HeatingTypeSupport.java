...
public class HeatingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Heating";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HeatingTypeSupport _singleton
    = new HeatingTypeSupport();
    ...
    */
    public static HeatingTypeSupport get_instance() {
        return _singleton;
    }

    public static HeatingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HeatingTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return Heating.create();
    }
    ...
    * <code>this</code> is not a <code>Heating</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        Heating typedDst = (Heating) destination;
        Heating typedSrc = (Heating) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        Heating typedSrc = (Heating) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Heating typedDst = (Heating) sample;
            deserialize_sample(
    ...
    int mask) {
        return new HeatingDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new HeatingDataReader(native_reader, listener, mask, this);   
    ...
    protected HeatingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, HeatingTypeCode.VALUE, Heating.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HeatingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, HeatingTypeCode.VALUE, Heating.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
